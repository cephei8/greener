...
Tool to report JUnit XML results to [Greener](https://codeberg.org/cephei8/greener/).
...
$ go install codeberg.org/cephei8/reporting/greener-reporter-junitxml@latest

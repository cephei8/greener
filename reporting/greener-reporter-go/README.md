...
$ go install github.com/cephei8/greener/reporting/greener-reporter-go@latest
...
For all the reporter configuration options see `greener-reporter-go --help` or [Plugin Configuration](https://github.com/cephei8/greener#plugin-configuration).

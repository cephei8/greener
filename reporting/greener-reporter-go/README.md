...
Tool to report Go test results to [Greener](https://git.sr.ht/~cephei8/greener/).
...
For all the reporter configuration options see `greener-reporter-go --help` or [Plugin Configuration](https://git.sr.ht/~cephei8/greener#plugin-configuration).
